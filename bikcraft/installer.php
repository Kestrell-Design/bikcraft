...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210421_bikcraft_60ccd294b1d4bbb69947_20210421190103_archive.zip';
	const ARCHIVE_SIZE		 = '25055879';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '60ccd29-21190103';
    const SECONDARY_PACKAGE_HASH = 'f0bc85f-21190103';
	const VERSION			 = '1.4.0';
